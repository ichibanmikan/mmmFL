...
9. Ensure that the rewards generated by your function in each round fall within a reasonable range, meaning that the absolute value of the rewards should not be too large.
        """
        self.Purpose = """ 
